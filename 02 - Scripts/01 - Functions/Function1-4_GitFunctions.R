...
#' # func_git_get_object("HEAD~1", object_name = "df_walleye")
#'
#' # Return full environment from a specific commit
#' # func_git_get_object("abc1234")
#'
#' @export

func_git_get_object <- function(
  commit,
...
#' # func_compare_object("df_walleye")
#'
#' # Compare all objects vs two commits back
#' # func_compare_object(commit = "HEAD~2")
#'
...
#' # func_compare_object("df_fish", object_name_old = "df_walleye")
#'
#' @export

func_compare_object <- function(
  object_name     = NULL,
  commit          = "HEAD~1",
  scripts         = "02_scripts/script00-00_user_interface.R",
  ...
  if (!is.null(object_name)) {
    ...
    obj_old <- func_git_get_object(commit = commit, scripts = scripts,
  ...
  old_env  <- func_git_get_object(commit = commit, scripts = scripts,
                                  object_name = NULL)
